...
function DayWiseReport() {
  ...
  useEffect(() => {
    ...
    // Initialize if empty to keep some dummy structure for demo
    ...
    // Sort by date descending (simple sort by string as dates are dd-mm-yyyy for now)
    // For proper sorting we should parse date, but let's keep it simple
    reportData.reverse(); 
